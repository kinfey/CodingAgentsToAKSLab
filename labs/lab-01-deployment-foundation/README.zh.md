...
> ⏱ **快速通道约 25 分钟 · 完整实验约 60 分钟** · **本实验系列不生成代码。** 多 Agent 应用已经存在于 `src/` 中。你要做的是克隆它、验证它能运行，并搭建它将被部署到的 Azure 基础设施。

🇬🇧 [English](./README.md)

### ⏱ 想在 2 小时内跑完整个系列？

只做 **核心** 步骤，跳过标注 *（可选）* 的步骤。可选步骤是深入讲解，实验 02–04 都不依赖它们。

| | 步骤 | 预算 |
|---|---|---|
| **核心** | 0、1、4、6、7、8、9、10、11、12、13、14 | 约 25 分钟 |
| *可选* | 2 代码导览 · 3 质量门禁 · 5 本地运行舰队 | 约 35 分钟 |

> 系列预算：**实验 01 约 25 分钟 · 实验 02 约 30 分钟 · 实验 03 约 35 分钟 · 实验 04 约 30 分钟 ≈ 2 小时。**
